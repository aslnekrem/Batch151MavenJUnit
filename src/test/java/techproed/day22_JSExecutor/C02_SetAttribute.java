...
//hocam element e sendKeys yapsak yapmazsa trycatch içinde jsSend Keys i kullansak metodda olmaz mı click metodu gibi?
    //genelde böyle kullanmak daha iyi olur. TestBase icerisinde önce normali dener olmazsa js dener. Bunu bu sekilde de
    //kullanabilirsin. Github'da her kodun method'u var ileride inceleyebilirsin.
@Test
public void test01() {
    ...
    public void test04() {
        ...
        driver.findElement(By.id("erol")).sendKeys("Java");
            /*
        Burada Developer'in yazmis oldugu kodda value degerine atama yaptik(degistirdik). Bu sekilde id'yi veya baska
        seyleri de degistirrebilirsin. Yani Developer'in yazdigi kod ile oynuyoruz. Normalde arama kutusunun kodunda
        calue degeri bosken biz onu settAttribute ile QA yap dedik. Sayfanin kaynak kodlarini degistiremiyoruz gecici
        süreligine yani.
