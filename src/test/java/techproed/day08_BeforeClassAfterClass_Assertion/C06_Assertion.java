...
public class C06_Assertion {
    /*
     ...
     Assertion'larda hata olursa bunu bize gösteriyor method icerisinde isleme devam etmiyor fakat kendinden sonra bir test methodu varsa
     o islemlere devam ediyor
      */
    @Test
    public void test01() {
