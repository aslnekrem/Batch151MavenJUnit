...
public abstract class TestBase {
    ...
    //SwitchTo Window -1 (Pencereleri arasi gecis yapmamizi saglayan method)
    public void switchToWindow(int index){
        List<String> pencereler = new ArrayList<>(driver.getWindowHandles());
        driver.switchTo().window(pencereler.get(index));
    }

    //SwitchTo Window -2 (Pencereleri arasi gecis yapmamizi saglayan method)
    ...
    public void click(WebElement element){
        try {
            ...
            JavascriptExecutor js = (JavascriptExecutor) driver;//casting yaptik. WebDriver --> JavaScript arayüzüne dönüstü
            js.executeScript("arguments[0].click;",element);
        }
        /*
        ilk olarak tiklamayi deniyor. Sonrasinda eger tiklayamazsa JavascriptExecutor ile her seye click yapabildigi icin
        onu kullaniyor. js.executeScript("arguments[0].click;",element); --> Bunu yazarken "" tirnak icerisine nokta, virgül
        vs'ye dikkat et. Cünkü String oldugu icin tek harfte bile hata alinir.
         */
        //JavascriptExecutor ile her türlü elementi locate edip islem yapabiliyoruz.
    }
